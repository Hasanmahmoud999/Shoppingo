        ...
        <Content style={{ marginTop: '15px', flexDirection: 'column' }}>
          ...
          <ParentSection>
            ...
            <RightSection className="PieCHART">
              {InformationCircleChar ? (
                <PieChart2
                  style={{ width: '100% !important' }}
                  InformationCircleChar={InformationCircleChar}
                />
              ) : (
                <PieChart2
                  style={{ width: '100% !important' }}
                  InformationCircleChar={infocirclechar}
                />
              )}
              <ColorContainer>
                <ColorDiv>
          ...
          <div style={{ marginTop: '20px' }}>
            {barcharinfo ? (
              <BarChart2 barcharinfo={barcharinfo} />
            ) : (
              <BarChart2 barcharinfo={defaultbarchar} />
            )}
          </div>
        </Content>
      </InnerContainer>
