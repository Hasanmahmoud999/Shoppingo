      ...
      >
        {props.repeater == 1 ? (
          ...
          >
            ...
            <span style={{ color: '#11324D' }}>
              Monthly Installment &nbsp;:&nbsp;&nbsp;
              <span style={{ color: '#6B7AA1', fontSize: '15px' }}>
                {props.monthly} s.p
              </span>
            </span>
            ...
            <div style={{ visibility: repeaternote }}>
              {props.message == 1 ? (
                <span style={{ color: 'green' }}>Paid this month</span>
              ) : (
                <span style={{ color: 'red' }}>No payment yet this month</span>
              )}
            </div>
          </div>
        ) : (
