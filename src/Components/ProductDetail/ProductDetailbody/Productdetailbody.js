        ...
        (err) => {
          ...
          switch (code) {
            case err.TIMEOUT:
              setErrMsg(
                <h4>
                  We Failed to get your location:
                  <br />
                  Timeout expired
                </h4>
              );
      ...
      <div className="detail">
        <form onSubmit={addToCart} className="product-detail">
          ...
          >
            ...
            >
              <button type="submit" className="add-shoppingcard">
                Add to <AddShoppingCart />
              </button>
            </div>
          </div>
            ...
            {Object.keys(product).length && id == product.id ? (
              product.old !== product.new ? (
                ...
                >
                  ...
                  <h6>{product.new} s.p</h6>
                </div>
              ) : (
                <div style={{ maxWidth: '340px', height: 'fit-content' }}>
                  {product.old} s.p
                </div>
              )
            ) : (
        ...
        {Object.keys(product).length && id == product.id ? (
          ...
          <div
            style={{
              ...
              alignItems: 'center',
              borderRadius: '25px',
              boxShadow: '5px 5px 20px 10px rgba(0,0,0,0.25)',
            }}
          >
